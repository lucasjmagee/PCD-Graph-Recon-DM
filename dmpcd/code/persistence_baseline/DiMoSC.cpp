...
#define MAX_DIM 4123			// - Will be used in Simplex.h
...
int main(int argc, char* argv[]){
	...
	persistenceFile = string(argv[2]) + "/persistence.txt";
	maxFile = string(argv[2]) + "/max.txt";
	...
	if (!use_pre_save){
		...
		K.PhatPersistence(persistenceFile);
		cout << "Done!\n";
		cout.flush();
...
//retrive
    ...
    K.retrieve_1manifold_simp(maxFile);
